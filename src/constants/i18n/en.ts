export const dict = {
  ...
  home: {
    ...
    description: "CardPass is a blockchain-based next-generation networking platform that blocks spam and rewards valuable connections",
      ...
      steps: [
        {
          ...
          description: "Issue your cNFT business card and set your contact price",
        },
        {
          title: "Network",
        ...
        {
          title: "Earn Rewards",
          description: "Get automatic rewards for responding or successful referrals",
        },
      ],
    },
    userTypes: {
    ...
    cta2: {
      title: "Start Now",
      subtitle: "Join CardPass and experience the new standard of spam-free professional networking",
  ...
  about: {
    ...
    mission: {
      title: "Our Mission",
      content: "CardPass revolutionizes professional networking by leveraging blockchain technology to create meaningful, spam-free connections with built-in value exchange mechanisms.",
    },
    technology: {
      title: "Technology Stack",
      content: "Built on Solana for speed and efficiency, using compressed NFTs for sustainable digital identity, and smart contracts for automated value distribution.",
    },
    contact: {
      title: "Contact Us",
    ...
    jobList: [
      {
        ...
        bounty: 500,
        posted: "2 days ago",
        description: "3+ years React/Vue.js experience, blockchain project experience preferred",
      ...
      },
      {
        ...
        bounty: 800,
        posted: "3 days ago",
        description: "Solana/Ethereum development experience required, proficient in Rust/Solidity",
      ...
      },
      {
        ...
        bounty: 1000,
        posted: "1 day ago",
        description: "NFT marketplace development experience, Solidity/Rust required",
