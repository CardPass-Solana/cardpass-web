export const dict = {
  ...
  home: {
    ...
    description: "CardPass는 스팸을 차단하고 가치 있는 연결에 보상하는 블록체인 기반 차세대 네트워킹 플랫폼입니다",
    cta: "지갑 연결 & 시작하기",
    browseJobs: "채용 정보 보기",
    features: {
      title: "핵심 기능",
    ...
    cta2: {
      title: "지금 시작하세요",
      subtitle: "CardPass에 가입하고 스팸 없는 전문 네트워킹의 새로운 기준을 경험하세요",
      button: "지갑 연결 & 명함 생성",
  ...
  about: {
    ...
    mission: {
      title: "우리의 미션",
      content: "CardPass는 블록체인 기술을 활용하여 내장된 가치 교환 메커니즘으로 의미 있고 스팸 없는 연결을 만들어 전문 네트워킹을 혁신합니다.",
    },
    technology: {
      title: "기술 스택",
      content: "속도와 효율성을 위해 솔라나에 구축되었으며, 지속 가능한 디지털 신원을 위한 압축 NFT와 자동화된 가치 분배를 위한 스마트 컨트랙트를 사용합니다.",
    },
    contact: {
      title: "연락처",
