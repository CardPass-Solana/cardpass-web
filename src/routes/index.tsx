...
export default function Home() {
  ...
  const userTypes = () => [
    {
      ...
      benefits: t("home.userTypes.professionals.benefits") as unknown as string[]
    },
    {
  ...
  const steps = () => [
    { number: "1", title: t("home.howItWorks.steps.0.title"), description: t("home.howItWorks.steps.0.description") },
    { number: "2", title: t("home.howItWorks.steps.1.title"), description: t("home.howItWorks.steps.1.description") },
    { number: "3", title: t("home.howItWorks.steps.2.title"), description: t("home.howItWorks.steps.2.description") }
  ];
  ...
  return (
    <main class="min-h-screen bg-gradient-to-b from-gray-900 to-black">
        ...
        <div class="container mx-auto px-4 py-20 relative">
          ...
          >
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
              <button class="group relative px-8 py-4 bg-gradient-to-r from-violet-600 to-cyan-600 text-white font-semibold rounded-xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl">
      ...
      <section class="py-20 bg-gray-900">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-white mb-4">{t("home.features.title")}</h2>
            ...
            <For each={features()}>
              {(feature, index) => (
                ...
                >
                  ...
                  <p class="text-gray-300 font-medium mb-2">{feature.description}</p>
      ...
      <section class="py-20 bg-gradient-to-b from-black to-gray-900">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-white mb-4">{t("home.howItWorks.title")}</h2>
      ...
      <section class="py-20 bg-gray-900">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-white mb-4">{t("home.userTypes.title")}</h2>
            ...
            <For each={userTypes()}>
              {(type) => (
                <div class="bg-gradient-to-br from-violet-900/20 to-cyan-900/20 p-8 rounded-2xl border border-gray-800 hover:border-violet-500/50 hover:shadow-xl hover:shadow-violet-500/10 transition-all">
                  <h3 class="text-2xl font-bold text-white mb-6">{type.title}</h3>
                  <ul class="space-y-4">
                    <For each={type.benefits}>
                      {(benefit) => (
                        <li class="flex items-start">
                          <svg class="w-6 h-6 text-green-500 mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section class="py-20 bg-gradient-to-r from-violet-600 to-cyan-600">
        <div class="container mx-auto px-4 text-center">
          ...
          <button class="group relative px-10 py-5 bg-white text-gray-900 font-bold text-lg rounded-xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-white/20">
        ...
        <div class="container mx-auto px-4">
          <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex gap-6">
              <a href="#" class="text-gray-400 hover:text-white transition-colors">{t("home.footer.links.docs")}</a>
              <a href="#" class="text-gray-400 hover:text-white transition-colors">{t("home.footer.links.github")}</a>
              <a href="#" class="text-gray-400 hover:text-white transition-colors">{t("home.footer.links.discord")}</a>
              <a href="#" class="text-gray-400 hover:text-white transition-colors">{t("home.footer.links.twitter")}</a>
            </div>
          </div>
