        ...
        <div class="bg-gray-900/50 backdrop-blur-sm rounded-xl border border-gray-800 p-6 mb-8">
          <div class="flex flex-col md:flex-row gap-4">
            ...
            >
              ...
              <option value={locale() === "ko" ? "정규직" : "full-time"}>{t("jobs.filterFullTime")}</option>
              <option value={locale() === "ko" ? "계약직" : "contract"}>{t("jobs.filterContract")}</option>
              <option value={locale() === "ko" ? "프리랜서" : "freelance"}>{t("jobs.filterFreelance")}</option>
            </select>
          </div>
        </div>
                ...
                <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                    ...
                    <div class="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <div class="flex flex-wrap items-center gap-3 text-gray-400 text-sm">
                          <span class="font-medium text-gray-300">{job.company}</span>
                          <span>•</span>
                  ...
                  <div class="flex flex-col items-end gap-3">
                    ...
                    <div class="flex gap-2">
                      <button class="px-4 py-2 bg-gray-800 text-white font-medium rounded-lg hover:bg-gray-700 transition-colors">
                        {t("jobs.applyButton")}
                      </button>
                      <button class="px-4 py-2 bg-gradient-to-r from-violet-600 to-cyan-600 text-white font-medium rounded-lg hover:shadow-lg hover:shadow-violet-500/25 transition-all">
